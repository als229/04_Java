...
public class TestRun {
	public static void main(String[] args) {
		...
		// - Child 객체 이지만 Parent 로 변경되어 Child 메서드 인식 불가 
...
//		System.out.println(p2.getCar()); // 오류 발생
		...
		// => (자료형)은 연산자 우선순위 2순위고 .은 1순위라 .먼저 해석돼서 (child)p2 를 괄호로 덮어줘야 에러 안남
		
		// 얕은 복사(주소만 복사)
		Child c2 = (Child)p2;
		
		System.out.println("p2.getCar() : " + c2.getCar());
	}
}
