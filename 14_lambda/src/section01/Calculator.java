...
//	void method(); // 오류발생 => @FunctionalInterface 쓰면 함수형이기 때문에 메서드 하나만 가능
	 ...
	 * 
	 * + 인터페이스는 여러 추상 메서드 작성이 가능하기 때문에 @FunctionalInterface를 이용해서 1개만 작성했는지 검사함
	 * 
...
// 자바는 메서드가 꼭 클래스 안에 존재해야 함. 함수는 클래스 밖에서도 독립적으로 존재 가능.
//public void test() {}