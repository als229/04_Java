...
public class MethodRefTest {
	...
	public static void main(String[] args) {
		...
		// => String을 매개 변수로 전달하면 String.length() 메서드를 참조해서 실행 후
		// 	  Integer 값을 반환
...
//		nameList.forEach(printName);
		...
		// 이미 똑같은 메서드가 존재하면 다시 작성하지 말고 참조하자!! => 메서드 참조
		Function <Integer, Integer> abs2 = Math::abs;
		
		System.out.println(abs2.apply(-50));
		System.out.println(abs2.apply(-150));
		System.out.println(abs2.apply(-250));
	}
}
