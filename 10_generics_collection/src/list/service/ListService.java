...
public class ListService {
	 ...
	 * - java.util 패키지에 존재
	 * 
	 * [Collefction Framework 특징]
	 * 1. 크기 제한 X
	 * 2. 추가 수정, 삭제, 정렬 등의 기능 제공
	 * 3. 객체만 저장 가능!
	 * 	- 기본 자료형은 Wrapper Class를 이용해서 저장
	 * 4. 기본적으로 타입 제한은 없지만 개발의 편의성을 위해 한 가지 타입으로 제한
	 * 	  => 제네릭스 이용
	 */
	
	/* [List(목록)]
	 * - 데이터를 순차적으로 나열한 자료 구조(배열 비슷) - 선형구조
	 * 
	 * [List 특징]
	...
	public void test1() {
		...
		/* E get(int index) : 리스트에서 index 번째 요소 E 반환 */
		 ...
		 * 	 => 제네릭스를 이용해 타입을 제한!
		 * 	 => 한 타입만 있을 테니까 검증, 다운캐스팅 할 필요가 없다.
		 */
	}
...
//		menuList.add(123); // 오류 발생(타입 불일치)
		...
		System.out.println("치킨 인덱스 : " + menuList.indexOf("햄버거"));
		...
		String delete = menuList.remove(1);
		
		System.out.println("================================================");
		System.out.println(delete + "이/가 삭제되었습니다.");
		System.out.println(menuList);
...
//		List<Integer> list = new ArrayList<Integer>();
		...
		// - 1970년 1월 1일 09:00:00:000(대한민국 기준)을 기준
		// 위 시간을 기준으로 현재 얼마만큼 시간이 지났는지 ms(1/1000초) 단위로 계산해서 반환
