...
public class PrintEx {
	public static void main(String[] args) {
		 ...
		 * 	(ln = line)
		 * 
		 * 3) System.olt.printf("문자열 템플릿(패턴)", 패턴에 대입될 값/변수...);
		 ...
		 * 
		 * 
		 * - 양의 정수 : 정수 크기 만큼 칸 확보 + 오른쪽 정렬
		 * ex) %4d, 3 대입 => ㅁㅁㅁ3 (ㅁ은 빈칸,4칸확보 후 오른쪽 정렬)
		 * 
		 * - 음의 정수 : 정수 크기 만큼 칸 확보 + 왼쪽 정렬
		 * ex) %-4d, 3 대입 => 3ㅁㅁㅁ (4칸확보 후 왼쪽 정렬)
		 * 
		 * - 소수점 : 소수점 아래 몇째 자리까지 표시할 지 지정( 지정된 자리 아래에서 반올림 처리)
		 * 
		 * ex) %.1f, 3.15 대입 => 3.2 
		 */
		...
		// (참고) 0 기호가 추가되면 빈칸에 0으로 채움(숫자만 가능)
		// 오른쪽 정렬
		System.out.println(); // 줄바꿈(개행)
		System.out.printf("%6s/%06d", name, age); //000005
		
		// ==================================================================================================
		System.out.println();
		System.out.println("=============================================================================");
		System.out.println("[escape 문자]");// 탈출 문자
