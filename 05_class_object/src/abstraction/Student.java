...
public class Student {
	...
	public Student() {
		...
		/* 생성자를 이용해서 객체가 생성 될 때 필드 값을 원하는 값으로 초기화 할 수 있다. */
	 ...
	 * - 같은 이름의 메서드는 원래 하나만 존재할 수 있지만 매개변수(순서,타입,개수)를 다르게 하여 같은 이름의 메서드라도 구분할 수 있게됨.
	 */
	
	/* 메서드 = 객체의 기능(함수) */
	
	/* 접근제어자 반환형 메서드명([매개변수]){ => 선언부
	 * 		// 메서드 정의   =>  구현부
	 * 	
	 * 		[return 값;]
	 * }
	...
	// setter : 외부에서 전달 받은 값을 객체의 필드에 셋팅하는 메서드
	...
	*/
	...
	public String toString() {
		 ...
		 * - System.out.printf() 처럼 작성하지만 출력되지 않고 String으로 반화
		 */
